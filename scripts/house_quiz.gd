...
var places := [
    {"name":"Σπίτι","symbol":"🏠"},{"name":"Είσοδος","symbol":"🚪"},
    {"name":"Σαλόνι","symbol":"🛋️"},{"name":"Κουζίνα","symbol":"🍳"},
    {"name":"Τραπεζαρία","symbol":"🍽️"},{"name":"Υπνοδωμάτιο","symbol":"🛏️"},
    {"name":"Παιδικό δωμάτιο","symbol":"🧸"},{"name":"Μπάνιο","symbol":"🛁"},
    {"name":"Διάδρομος","symbol":"🚶"},{"name":"Μπαλκόνι","symbol":"🌇"},
    {"name":"Κήπος","symbol":"🌳"},{"name":"Αυλή","symbol":"🏡"},
    {"name":"Γκαράζ","symbol":"🚗"},{"name":"Αποθήκη","symbol":"📦"},
    {"name":"Σκάλα","symbol":"🪜"},{"name":"Πόρτα","symbol":"🚪"},
    {"name":"Παράθυρο","symbol":"🪟"},{"name":"Στέγη","symbol":"🏠"},
    {"name":"Καμινάδα","symbol":"🏭"},{"name":"Γραφείο","symbol":"💻"}
]
...
func _new_round() -> void:
    ...
    feedback_label.text = ""
    next_button.visible = false
    correct_index = randi_range(0, places.size() - 1)
    target_label.text = "Βρες: " + places[correct_index]["name"]
    ...
    while choices.size() < 4:
        var candidate := randi_range(0, places.size() - 1)
    ...
    for value in choices:
        ...
        button.text = places[value]["symbol"]
...
func _speak_current() -> void:
    ...
    if voices.size() > 0:
        ...
        DisplayServer.tts_speak(places[correct_index]["name"], voices[0])
