...
var animals := [
    {"letter":"Α","name":"Αλεπού","symbol":"🦊"},{"letter":"Β","name":"Βάτραχος","symbol":"🐸"},
    {"letter":"Γ","name":"Γάτα","symbol":"🐱"},{"letter":"Δ","name":"Δελφίνι","symbol":"🐬"},
    {"letter":"Ε","name":"Ελάφι","symbol":"🦌"},{"letter":"Ζ","name":"Ζέβρα","symbol":"🦓"},
    {"letter":"Η","name":"Ημίονος","symbol":"🐴"},{"letter":"Θ","name":"Θαλάσσιος ίππος","symbol":"🦭"},
    {"letter":"Ι","name":"Ιπποπόταμος","symbol":"🦛"},{"letter":"Κ","name":"Κοάλα","symbol":"🐨"},
    {"letter":"Λ","name":"Λιοντάρι","symbol":"🦁"},{"letter":"Μ","name":"Μέλισσα","symbol":"🐝"},
    {"letter":"Ν","name":"Νυχτερίδα","symbol":"🦇"},{"letter":"Ξ","name":"Ξιφίας","symbol":"🐟"},
    {"letter":"Ο","name":"Όρκα","symbol":"🐋"},{"letter":"Π","name":"Πιγκουίνος","symbol":"🐧"},
    {"letter":"Ρ","name":"Ρινόκερος","symbol":"🦏"},{"letter":"Σ","name":"Σκύλος","symbol":"🐶"},
    {"letter":"Τ","name":"Τίγρη","symbol":"🐯"},{"letter":"Υ","name":"Ύαινα","symbol":"🐕"},
    {"letter":"Φ","name":"Φάλαινα","symbol":"🐋"},{"letter":"Χ","name":"Χελώνα","symbol":"🐢"},
    {"letter":"Ψ","name":"Ψάρι","symbol":"🐠"},{"letter":"Ω","name":"Ωταρία","symbol":"🦭"}
]
...
func _new_round() -> void:
    ...
    title_label.text = "Ποιο ζώο αρχίζει από " + animals[correct_index]["letter"] + ";"
    ...
    while choices.size() < 4:
        var candidate := randi_range(0, animals.size() - 1)
    ...
    for value in choices:
        ...
        button.text = animals[value]["symbol"] + "\n" + animals[value]["name"]
        button.custom_minimum_size = Vector2(300, 145)
...
func _answer(chosen: int) -> void:
    ...
    if chosen == correct_index:
        answered = true
        feedback_label.text = "Μπράβο! Σωστό ζώο! ⭐"
        stars += 1
        stars_label.text = "⭐ %d" % stars
...
func _speak_current() -> void:
    ...
    if voices.size() > 0:
        ...
        DisplayServer.tts_speak("Ποιο ζώο αρχίζει από " + animals[correct_index]["letter"] + ";", voices[0])
