...
var countries := [
    {"name":"Ελλάδα","flag":"🇬🇷"},{"name":"Κύπρος","flag":"🇨🇾"},{"name":"Ιταλία","flag":"🇮🇹"},
    {"name":"Γαλλία","flag":"🇫🇷"},{"name":"Γερμανία","flag":"🇩🇪"},{"name":"Ισπανία","flag":"🇪🇸"},
    {"name":"Πορτογαλία","flag":"🇵🇹"},{"name":"Ηνωμένο Βασίλειο","flag":"🇬🇧"},{"name":"Ιρλανδία","flag":"🇮🇪"},
    {"name":"Ολλανδία","flag":"🇳🇱"},{"name":"Βέλγιο","flag":"🇧🇪"},{"name":"Ελβετία","flag":"🇨🇭"},
    {"name":"Αυστρία","flag":"🇦🇹"},{"name":"Νορβηγία","flag":"🇳🇴"},{"name":"Σουηδία","flag":"🇸🇪"},
    {"name":"Φινλανδία","flag":"🇫🇮"},{"name":"Δανία","flag":"🇩🇰"},{"name":"Πολωνία","flag":"🇵🇱"},
    {"name":"Τσεχία","flag":"🇨🇿"},{"name":"Ρουμανία","flag":"🇷🇴"},{"name":"Βουλγαρία","flag":"🇧🇬"},
    {"name":"Τουρκία","flag":"🇹🇷"},{"name":"Ηνωμένες Πολιτείες","flag":"🇺🇸"},{"name":"Καναδάς","flag":"🇨🇦"},
    {"name":"Μεξικό","flag":"🇲🇽"},{"name":"Βραζιλία","flag":"🇧🇷"},{"name":"Αργεντινή","flag":"🇦🇷"},
    {"name":"Χιλή","flag":"🇨🇱"},{"name":"Αίγυπτος","flag":"🇪🇬"},{"name":"Νότια Αφρική","flag":"🇿🇦"},
    {"name":"Κένυα","flag":"🇰🇪"},{"name":"Μαρόκο","flag":"🇲🇦"},{"name":"Κίνα","flag":"🇨🇳"},
    {"name":"Ιαπωνία","flag":"🇯🇵"},{"name":"Ινδία","flag":"🇮🇳"},{"name":"Νότια Κορέα","flag":"🇰🇷"},
    {"name":"Ταϊλάνδη","flag":"🇹🇭"},{"name":"Ινδονησία","flag":"🇮🇩"},{"name":"Αυστραλία","flag":"🇦🇺"},
    {"name":"Νέα Ζηλανδία","flag":"🇳🇿"}
]
...
func _new_round() -> void:
    ...
    feedback_label.text = ""
    next_button.visible = false
    correct_index = randi_range(0, countries.size() - 1)
    target_label.text = "Βρες τη σημαία της χώρας: " + countries[correct_index]["name"]
    ...
    while choices.size() < 4:
        var candidate := randi_range(0, countries.size() - 1)
    ...
    for value in choices:
        ...
        button.text = countries[value]["flag"]
...
func _answer(chosen: int) -> void:
    ...
    if chosen == correct_index:
        answered = true
        feedback_label.text = "Μπράβο! Σωστή σημαία! ⭐"
        stars += 1
        stars_label.text = "⭐ %d" % stars
...
func _speak_current() -> void:
    ...
    if voices.size() > 0:
        ...
        DisplayServer.tts_speak("Βρες τη σημαία της χώρας " + countries[correct_index]["name"], voices[0])
